...
public class StartMenuView : MonoBehaviour
{
    ...
    [SerializeField] private float startFruitScale = 0.72f;
    [SerializeField] private Vector3 menuCanvasPosition = new Vector3(0f, 1.85f, -14f);
    [SerializeField] private Vector3 menuCanvasEulerAngles = new Vector3(0f, 0f, 0f);
    [SerializeField] private Vector2 menuCanvasSize = new Vector2(2.4f, 0.75f);
    [SerializeField] private float menuCanvasScale = 0.003f;
    ...
    private void CreateStartFruits()
    {
        ...
        CreateModeFruit(FruitNinjaMode.Classic, new Vector3(-2.05f, 0.7f, -14f), "CLASSIC", new Color(1f, 0.82f, 0.08f));
        CreateModeFruit(FruitNinjaMode.Arcade, new Vector3(-0.68f, 1.12f, -14f), "ARCADE", new Color(0.1f, 0.72f, 1f));
        CreateModeFruit(FruitNinjaMode.Zen, new Vector3(0.68f, 1.12f, -14f), "ZEN", new Color(0.45f, 1f, 0.18f));
        CreateModeFruit(FruitNinjaMode.Battle, new Vector3(2.05f, 0.7f, -14f), "BATTLE", new Color(1f, 0.36f, 0.18f));
    }

    private void CreateModeFruit(FruitNinjaMode mode, Vector3 position, string label, Color ringColor)
    {
        ...
        trigger.Init(mode);
        ModeSelectionRing ring = fruit.AddComponent<ModeSelectionRing>();
        ring.Init(label, ringColor);
